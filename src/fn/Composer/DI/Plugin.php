...
class Plugin implements PluginInterface, EventSubscriberInterface
{
    ...
    public static function onAutoloadDump(Event $event)
    {
        ...
        $fs = new Filesystem;
        $baseDir = $fs->normalizePath(realpath(realpath(getcwd()))) . '/';
...
return call_user_func(function(\$loader) {
    return fn\Composer\DI\ClassLoader::instance(
        \$loader,
...
EOF
    ...
    private static function generateAutoloadFile(string $file, string $baseDir, string $vendorDir, $di, $config)
    {
        $classes = \implode(
            PHP_EOL,
            \iterator_to_array(new Generator\Provider((array)$di, (array)$config)
        ));
